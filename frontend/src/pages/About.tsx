...
export default function About() {
  return (
    <main className="pt-28 sm:pt-36 lg:pt-48">
      {/* Hero Section */}
      <section className="px-5 sm:px-8 md:px-12 max-w-7xl mx-auto mb-16 md:mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <h1 className="font-headline text-4xl sm:text-5xl lg:text-6xl font-extrabold text-on-surface mb-6 md:mb-8 leading-[1.1]">Roots that Run as Deep as the <span className="text-primary italic">Kigezi Terraces</span></h1>
            <p className="font-body text-base sm:text-lg md:text-xl text-on-surface-variant leading-relaxed max-w-lg">
      ...
      <section className="bg-surface-container-low py-16 md:py-24 px-5 sm:px-8 md:px-12">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-8">
            <div className="max-w-2xl">
              <h2 className="font-headline text-3xl sm:text-4xl md:text-5xl font-black text-on-surface mb-6 uppercase">The Spirit of Kigezi</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
            ...
            <div className="md:col-span-4 grid grid-rows-2 gap-6 min-h-[440px] md:min-h-0">
      ...
      <section className="py-16 md:py-24 px-5 sm:px-8 md:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div>
            ...
            <h2 className="font-headline text-3xl sm:text-4xl md:text-5xl font-black text-on-surface mb-8 leading-tight">From Highland Soil to <span className="text-primary">Cultural Custodian</span></h2>
            <div className="space-y-6 font-body text-on-surface-variant text-lg">
              ...
              <div className="grid grid-cols-1 min-[380px]:grid-cols-2 gap-4 sm:gap-6 pt-8">
                <div className="p-6 bg-surface-container rounded-xl">
                  <p className="font-headline text-3xl font-black text-primary mb-1">15+</p>
                  <p className="font-label text-xs font-bold text-on-surface-variant uppercase">Community Artisans Supported</p>
                </div>
                <div className="p-6 bg-surface-container rounded-xl">
                  <p className="font-headline text-3xl font-black text-primary mb-1">100%</p>
                  <p className="font-label text-xs font-bold text-on-surface-variant uppercase">Authentic Experience</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 px-5 sm:px-8">
        <div className="max-w-5xl mx-auto bg-inverse-surface rounded-2xl md:rounded-[40px] p-6 sm:p-10 md:p-20 text-center relative overflow-hidden">
